...
<body class="bg-gray-100">
    ...
    <div id="add-parent-modal" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-600 mb-1">Parent Name*</label>
                <input type="text" id="add-parent-name" class="border rounded-lg p-2 w-full" placeholder="Enter parent name">
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-600 mb-1">Relation with Student</label>
                <input type="text" id="add-relation" class="border rounded-lg p-2 w-full" placeholder="e.g., Father, Mother, Guardian">
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-600 mb-1">Contact Number</label>
                <input type="text" id="add-contact" class="border rounded-lg p-2 w-full" placeholder="Enter contact number">
            </div>
            <div class="mb-4">
            ...
            <div class="flex justify-end space-x-2">
                <button onclick="closeModal('add-parent-modal')" class="bg-gray-500 text-white px-4 py-2 rounded-md">Cancel</button>
    ...
    <div id="edit-parent-modal" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="flex justify-end space-x-2">
                <button onclick="closeModal('edit-parent-modal')" class="bg-gray-500 text-white px-4 py-2 rounded-md">Cancel</button>
                <button onclick="updateParent()" class="bg-blue-500 text-white px-4 py-2 rounded-md">Save Changes</button>
            </div>
                            ...
                            <div class="parent-row mb-2 p-3 rounded bg-gray-50">
                                <div class="flex justify-between items-start">
                                    ...
                                    <div class="flex space-x-2">
                                        <button onclick="openEditParentModal(${parent.parent_id}, ${item.student_id}, '${item.student_name}', '${parent.name}', '${parent.relation || ''}', '${parent.contact || ''}', '${parent.address || ''}')" 
                                                class="text-blue-600 hover:text-blue-800 text-sm">
                                            Edit
                                        </button>
                                        <button onclick="openDeleteModal(${parent.parent_id}, '${parent.name}')" 
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6 flex justify-end space-x-3">
            <button onclick="openLinkExistingParentModal()" 
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M12 13a1 1 0 100-2H8a1 1 0 100 2h4zm0-6a1 1 0 100-2H8a1 1 0 100 2h4z" clip-rule="evenodd" />
                </svg>
    ...
    <div id="link-parent-modal" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="flex justify-end space-x-2">
                <button onclick="closeModal('link-parent-modal')" class="bg-gray-500 text-white px-4 py-2 rounded-md">Cancel</button>
                <button onclick="linkExistingParent()" class="bg-green-500 text-white px-4 py-2 rounded-md">Link Parent</button>
            </div>

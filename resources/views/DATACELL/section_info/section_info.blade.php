        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            ...
            <div class="flex space-x-3">
                ...
                <div class="dropdown relative">
                    <button id="programFilterBtn" class="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-lg flex items-center">
                ...
                <div class="dropdown relative" id="semesterFilterContainer" style="display: none;">
                    <button id="semesterFilterBtn" class="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-lg flex items-center">
                ...
                <button id="addSectionBtn" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center">
                    ➕ Add New Section
                </button>
            </div>
        </div>
            ...
            <div class="p-4">
                ...
                <form id="regularForm" class="form-container active">
                    <div class="mb-4">
                        ...
                        <select id="program" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="semester" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="group" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <button type="submit" id="saveRegularBtn" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">
                ...
                <form id="extraForm" class="form-container">
                    <div class="mb-4">
                        ...
                        <input type="text" id="prefix" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="e.g., HS, DS" required>
                        <p class="text-xs text-gray-500 mt-1">This will be combined with "ExtraSection" (e.g., HSExtraSection)</p>
                    </div>
                    <div class="mb-4 bg-blue-50 p-3 rounded border border-blue-100">
                        <label class="block text-gray-700 text-sm font-bold mb-2">Section Name</label>
                    ...
                    <div class="flex justify-end space-x-3">
                        <button type="button" id="cancelBtnExtra" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-lg">
                            Cancel
                        </button>
                        <button type="submit" id="saveExtraBtn" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">
                            Save Extra Section
                        </button>
                    </div>
                </form>
    ...
    <script>
        ...
        function populateProgramFilter() {
            ...
            allOption.onclick = (e) => {
                ...
                document.getElementById('programFilterBtn').innerHTML = 'Filter by Program <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>';
            ...
            Object.keys(sectionsData).forEach(program => {
                ...
                option.onclick = (e) => {
                    ...
                    document.getElementById('programFilterBtn').innerHTML = `${program} <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>`;
                    populateSemesterFilter(program);
                    document.getElementById('semesterFilterContainer').style.display = 'block';
                    document.getElementById('semesterFilterBtn').innerHTML = 'Filter by Semester <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>';
                    currentSemesterFilter = null;
        ...
        function populateSemesterFilter(program) {
            ...
            semesters.forEach(semester => {
                ...
                option.onclick = (e) => {
                    ...
                    document.getElementById('semesterFilterBtn').innerHTML = `Semester ${semester} <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>`;
        ...
        function renderSemesters(program, semestersData) {
            ...
            Object.entries(semestersData).forEach(([semester, sections]) => {
                ...
                const semesterStudents = sections.reduce((total, section) => total + (section.student_count || 0), 0);
